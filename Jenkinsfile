    ...
    stages {
        ...
        stage('Checkov scan') {
            steps {
                ...
                #checkov -d . #scanning the directory
                #checkov -d . --skip-check CKV_AWS_23,CKV_AWS_24,CKV_AWS_126,CKV_AWS_135,CKV_AWS_8,CKV_AWS_23,CKV_AWS_24 #run all checks except the once specified
                checkov -d . --skip-check CKV_AWS* #using wildcat to skip checks matching this pathern
                """
